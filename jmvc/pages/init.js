...
If you are new to the framework, the [getstarted Getting Started Guide] is the best place to start.  There, you'll install JavaScriptMVC, create an app, test, compress, and document it.  Or, if you're in a hurry, try the [rapidstart Rapid Start Guide].
...
Each component also has corresponding article(s) over at the blog:
...
If all else fails, head over to the [api API page] for a complete listing of every page in the Documentation.
