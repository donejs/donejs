...
<a name="section=section_CodeofConduct"></a>
## Code of Conduct
...
<a name="section=section_GettingHelp"></a>
## Getting Help
...
<a name="section=section_ProjectOrganization"></a>
...
<a name="section=section_ReportingBugs"></a>
## Reporting Bugs
...
<a name="section=section_SuggestingFeatures"></a>
## Suggesting Features
...
<a name="section=section_FindingWaystoContribute"></a>
...
<a name="section=section_Findingopenissues"></a>
### Finding open issues
...
<a name="section=section_Spreadingtheword"></a>
### Spreading the word
...
<a name="section=section_DevelopingLocally"></a>
## Developing Locally
...
<a name="section=section_SigningupforGitHub"></a>
...
<a name="section=section_Forking_cloningtherepository"></a>
...
<a name="section=section_Installingthedependencies"></a>
...
<a name="section=section_Runningthetests"></a>
### Running the tests
...
<a name="section=section_Buildingthedocumentation"></a>
...
<a name="section=section_Viewingthesite"></a>
### Viewing the site
...
<a name="section=section_ChangingtheCode"></a>
## Changing the Code
...
<a name="section=section_Creatinganewbranch"></a>
...
<a name="section=section_Updatingthedocumentation"></a>
...
<a name="section=section_Submittingapullrequest"></a>
...
<a name="section=section_UpdatingDoneJS_com"></a>
## Updating DoneJS.com
...
<a name="section=section_Evangelism"></a>
## Evangelism
...
<a name="section=section_Writingablogarticle"></a>
### Writing a blog article
...
<a name="section=section_Speakingataconferenceormeetup"></a>
### Speaking at a conference or meetup

The [presentations list](./presentations.html) contains a variety of talks related to the DoneJS projects.

<a name="section=section_OrganizingaDoneJSmeetup"></a>
### Organizing a DoneJS meetup
